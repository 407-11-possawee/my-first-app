...
st.markdown("# :green[🏃แอปพลิเคช้นคำนวณค่าดัชนีมวลกาย BMI]")
st.write("กรอกข้อมูลน้ำหนักและส่วนสูงของคุณ เพื่่อเช็กสุขภาพเบื้องต้น")
...
if bmi < 18.5:
   ...
   st.info("❤️คุณเริ่มมีน้ำหนักเกินเกณฑ์ (ท่วม)")
else:
   st.error("🚨คุณอยู่ในเกณฑ์อ้วน ควรระวังสุขภาพและออกกำลังกาย")
