...
st.title("😘 เกมทายศัพท์จับเวลาภาษาอังกฤษ")
...
ans1 = st.text_input(
    "ข้อ 1: `สิ่งที่อยู่ในห้องครัวและคม` ",
    value=st.session_state.ans1_val,
)
ans2 = st.text_input(
    "ข้อ 2: `สิ่งที่อยู่ในห้องครัวและเรามักจะใช้ใส่น้ำเพื่อดื่ม` ",
    value=st.session_state.ans2_val,
)
ans3 = st.text_input(
    "ข้อ 3: `สิ่งที่อยู่ในห้องครัวและเรามักจะใช้สิ่งนี้เพื่อใช้วางของ` ",
    value=st.session_state.ans3_val,
)
ans4 = st.text_input(
    "ข้อ 4: `สิ่งที่อยู่ในห้องน้ำเป็นก้อนและใช้ทำความสอาดตัว` ",
    value=st.session_state.ans4_val,
)
ans5 = st.text_input(
    "ข้อ 5: `สิ่งที่เราใช้เพื่อทำเส้นตรง` ",
...
st.divider()
st.write("นายพศวีร์ สอาดสุด เลขที่ 11 4/7 นายศุภกร วงศ์ใหม่ เลขที่ 15 4/7 นางสาวรัตน์รดา สอาดสุด เลขที่ 16 4/7 นายวสกิจ ล้ำวีรประเสริฐ เลขที่ 42 4/7")
